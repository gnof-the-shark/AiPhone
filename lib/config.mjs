 ...
 * Used for AI-powered conversational SMS.
 */
export const GEMINI_API_KEY = process.env.GEMINI_API_KEY || "";

/**
 * Gemini model to use for SMS replies.
 */
export const GEMINI_MODEL = process.env.GEMINI_MODEL || "gemini-1.5-flash";

/**
 * List of phone numbers allowed to use the AI via SMS.
 * Comma-separated E.164 strings.
 */
export const ALLOWED_NUMBERS = (process.env.ALLOWED_NUMBERS || "").split(',').map(s => s.trim()).filter(Boolean);
